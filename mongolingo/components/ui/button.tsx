  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive uppercase tracking-wide font-bold",
  {
    variants: {
      variant: {
        ...
        primary:
          "bg-sky-400 text-primary-foreground hover:bg-sky-400/90 border-sky-500 border-b-[4px] active:border-b-0",
        primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",

        secondary:
          "bg-green-500 text-primary-foreground hover:bg-green-400/90 border-green-600 border-b-[4px] active:border-b-0",
        secondaryOutline: "bg-green text-green-500 hover:bg-slate-100",
        danger:
          "bg-rose-500 text-primary-foreground hover:bg-rose-400/90 border-rose-600 border-b-[4px] active:border-b-0",
        dangerOutline: "bg-rose text-rose-500 hover:bg-slate-100",
        super:
          "bg-indigo-500 text-primary-foreground hover:bg-indigo-400/90 border-indigo-600 border-b-[4px] active:border-b-0",
        superOutline: "bg-indigo text-indigo-500 hover:bg-slate-100",
        ghost:
          "bg-trasnparent text-slate-500 border-transparent border-0 hover:bg-slate-100",
        sidebar:
